...
public:
    ...
    {
        // Starlightcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Starlightcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Starlightcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Starlightcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Starlightcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Starlightcoin: block index flags
    enum  
    {
