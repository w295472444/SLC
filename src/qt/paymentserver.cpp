...
const QString BITCOIN_IPC_PREFIX("Starlightcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Starlightcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Starlightcoin: click-to-pay handler");
    else
...
{
    // clicking on Starlightcoin: URLs creates FileOpen events on the Mac:
